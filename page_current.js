...
export default function Home() {
  ...
  return (
    ...
    {T==="p"&&<div style={{padding:16,maxWidth:1200,margin:"0 auto"}}>
      ...
      <Tabel title={"Penjualan Harian 2026 - "+BA} data={[...pj].reverse()} cols={["tgl","tt","kj"]} fmt={(k,v)=>k==="tt"?fr(v):v}/>
      {B24&&<Tabel title={"Penjualan Harian 2024 - "+B24} data={[...p24].reverse()} cols={["tgl","tt","kj"]} fmt={(k,v)=>k==="tt"?fr(v):v}/>}
      {B25&&<Tabel title={"Penjualan Harian 2025 - "+B25} data={[...p25].reverse()} cols={["tgl","tt","kj"]} fmt={(k,v)=>k==="tt"?fr(v):v}/>}
    </div>}
